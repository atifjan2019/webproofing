                    ...
                    <div class="site-card-new animate-fadeInUp" style="animation-delay: {{ $loop->index * 50 }}ms">
                        ...
                        <div class="site-card-actions">
                            @if(!auth()->user()->hasGoogleAccount())
                                <a href="{{ route('sites.google', $site) }}" class="site-quick-action warning"
                                    title="Google not connected - Click to connect">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                    </svg>
                                </a>
                            @elseif(!$site->hasGa4() && !$site->hasGsc())
                                <a href="{{ route('sites.google', $site) }}" class="site-quick-action warning"
                                    title="Google Analytics & Search Console not configured">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                    </svg>
                            ...
                            <a href="{{ route('sites.pagespeed', $site) }}" class="site-quick-action" title="Speed Test">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
